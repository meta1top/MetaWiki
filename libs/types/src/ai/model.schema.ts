...
export const CreateModelSchema = z.object({
  ...
  type: ModelTypeEnum.describe("模型类型"),
  contextLength: z.number().int().positive("上下文长度必须为正整数").nullable().optional().describe("上下文长度"),
  functionCalling: z.boolean().describe("是否支持Function Calling"),
...
export const UpdateModelSchema = z.object({
  ...
  type: ModelTypeEnum.optional().describe("模型类型"),
  contextLength: z.number().int().positive("上下文长度必须为正整数").nullable().optional().describe("上下文长度"),
  functionCalling: z.boolean().optional().describe("是否支持Function Calling"),
  enabled: z.boolean().optional().describe("是否启用"),
  description: z.string().nullable().optional().describe("描述"),
});
